...
export function CreditBalancePill() {
  ...
  return (
    <Link
      href="/billing"
      className="inline-flex items-center gap-2 rounded-[4px] bg-surface-container-low px-3 py-1.5 font-mono text-xs text-on-surface-variant transition-colors hover:bg-surface-container hover:text-on-surface"
    >
