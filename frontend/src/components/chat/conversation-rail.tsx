    ...
    <aside className="flex h-full flex-col gap-1 overflow-y-auto rounded-[4px] bg-surface-container-low p-3">
      ...
      {conversations.map((conv) => {
        ...
        return (
          <div
            key={conv.id}
            className={`group relative rounded-[4px] px-2.5 py-2 transition-colors ${
              isActive
          ...
          >
            ...
            <div className="absolute right-1.5 top-1.5 flex items-center gap-0.5 opacity-0 transition-opacity group-hover:opacity-100 group-focus-within:opacity-100">
              <button
                ...
                className="flex h-6 w-6 items-center justify-center rounded-[4px] text-on-surface-variant transition-colors hover:bg-secondary/10 hover:text-secondary"
              >
                <svg
                  className="h-3 w-3"
                  fill="none"
              ...
              <button
                ...
                className="flex h-6 w-6 items-center justify-center rounded-[4px] text-on-surface-variant transition-colors hover:bg-error/10 hover:text-error"
              >
                <svg
                  className="h-3 w-3"
                  fill="none"
